...
function createSignUp() {
  ...
  form.setAttribute("class", "sideform");
  ...
  usernameInput.setAttribute("placeholder", "Create username here");
  ...
  passwordInput.setAttribute("placeholder", "Create password here");
  ...
  document.querySelector("#signup").appendChild(form);
}
//DONE 👇
function createLogin() {
  ...
  document.querySelector("#login").appendChild(form);
}
